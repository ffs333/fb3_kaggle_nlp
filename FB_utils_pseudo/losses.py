...
def get_loss_func(cfg):
    ...
    elif cfg.loss == 'pseudo':
        loss_fn = WeightedPseudoL1Loss(beta_l1=cfg.beta_L1)
...
class WeightedPseudoL1Loss(nn.Module):
    def __init__(self, beta_l1=0.125):
        super().__init__()

        self.l1 = nn.SmoothL1Loss(reduction='none', beta=beta_l1)
